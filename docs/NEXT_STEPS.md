...
| **백엔드** | 🚧 Nest 12 · Prisma 29테이블 · API 클라이언트 · 배치 upsert · **L0**(17대회 · 82대회시즌 · 팀 1,888) · **조회 API 4개** · **L1 스쿼드**(155팀 · 선수 4,863 적재, 관문 테스트 21건 통과) |
...
| 5 | **L2 일정·라운드** | 8 | 여기서 UCL 예선팀도 걷어낸다 |
| 6 | **백업 자동화 · 사본 이중화 · 리허설 재실행** | 4 | **백필 착수 직전.** 백필은 8~12일 무인 실행이다 |
| 7 | **L2 백필 실행** | 8 | 6번이 끝나야 시작한다 |

병렬 가능: 2번은 1·3·4와 무관하다. 7단계 화면 작업(대진표·시즌 선택기)도 언제든 끼워넣을 수 있다.

**되돌리기 어려운 순서는 6→7 하나다.** 나머지는 바꿔도 된다.
...
예선팀과 리그페이즈 팀을 구분하려면 **라운드 데이터가 필요하다** — 그게 이 단계다.
