...
>
> **2026-09-17 실측 정정 (docs/scope-reconcile)**: L2 5시즌 적재 후 국내 컵 6개 시즌당 합계 실측 = **541경기**
> (Coupe de France 660/5=132 · Copa del Rey 465/5=93 · DFB Pokal 300/5=60 · FA Cup 277/5=55 · League Cup 268/5=54 · Coppa Italia 196/5=39).
> INGESTION_STRATEGY 3-1 종전 추정 222경기/시즌은 컷 후 상세 대상만 · **목록 수집 대상은 실측 541** — 2.4배.
> 이 파일의 "시즌 경기" 컬럼은 시즌 2025 API 응답 전체 (컷 전) 이라 정본 5시즌 실측과 별개.
