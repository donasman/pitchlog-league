...
description: PitchLog 문서 최신화 · 문서 정리 · 문서 동기화 · 문서 갱신을 할 때. 기능이 머지되거나 실 적재 결과가 나온 뒤, 또는 "문서가 낡았다" · "놓친 게 있는지 보자" 같은 요청에 쓴다. 어느 문서를 고치고, 같은 문서 안의 모순과 문서 간 불일치를 어떻게 두 번 검토하는지, 무엇을 손대지 않는지가 들어 있다.
---
